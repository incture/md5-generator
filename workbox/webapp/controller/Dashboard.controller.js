		...
		fetchGraphDetailFn: function (oEvent) {
			...
			//if graph data is clicked
				...
				if (selectedGraphData.Month || selectedGraphData.Date) {
					...
					if (oGraphDataModel.getProperty("/selectedDuration") === "month") {
						oAppModel.setProperty("/graphYear", selectedGraphData.Month);
					} else {
						oAppModel.setProperty("/graphYear", selectedGraphData.Date);
					}
