sap.ui.define([
	...
	return Controller.extend("oneapp.incture.workbox.controller.BaseController", {
		...
		getLoggedInUserDetails: function () {
			var oAppModel = this.oAppModel;
			var sUrl = "/WorkboxJavaService/idpMapping/getUsersDetails";
		...
		setInboxPanel: function () {
			this.doAjax("/WorkboxJavaService/inbox/inboxPanel", "GET", null, function (oData) {
		...
		getStandardSettings: function () {
			var url = "/WorkboxJavaService/notificationConfiguration/getAllSettingDetails"
		...
		updateNotification: function () {
			var url = "/WorkboxJavaService/notification/getNotification";
			var oUserSettingsModel = this.getModel("oUserSettingsModel");
		...
		downloadAttachment: function (attachmentId, fileType, fileName, base64File, fileSize, bDownloadAll, encodedFile, isChat) {
			...
			if (attachmentId) {
				if (isChat) {
					...
					var url = "/WorkboxJavaService/detailPage/getOriginalAttachment/" + attachmentId;
					this.doAjax(url, "GET", null, function (oData) {
		...
		fetchSavedFilters: function () {
			...
			var url = "/WorkboxJavaService/userCustomFilter/getFilters";
			this.doAjax(url, "GET", null, function (oData) {
