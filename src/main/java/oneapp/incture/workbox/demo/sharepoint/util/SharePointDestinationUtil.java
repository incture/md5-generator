...
public class SharePointDestinationUtil {

	private static final Logger logger = LoggerFactory.getLogger(SharePointDestinationUtil.class);
...
//		SharePointDestinationUtil.executeWithDest("destincationName", "/absoluteURL", "GET/POST", "application/json", null, null, "Internet", false, null, null);
//	}
