package oneapp.incture.workbox.demo.adminConsole.dao;
...
import oneapp.incture.workbox.demo.adapter_base.entity.ReportAgingDo;
...
@Repository("AdminConsoleReportAgingDao")
//////@Transactional
