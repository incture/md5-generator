...
public class EmailContentDo implements BaseDo,Serializable{
	...
	public String toString() {
		return "EmailContentDo [templateId=" + templateId + ", version=" + version + ", to=" + to + ", cc=" + cc + ", bcc=" + bcc + ", subject="
				+ subject + ", messageBody=" + messageBody + ", isAttachment=" + isAttachment + ", attachmentId="
				+ attachmentId + ", isTableContent=" + isTableContent + ", tableContentId=" + tableContentId
				+ ", frameId=" + frameId + "]";
	}
