...
public class TaskEventsDto extends BaseDto {
	...
	public String toString() {
		return "TaskEventsDto [requestId=" + requestId + ", eventId=" + eventId + ", processId=" + processId
				...
				+ ", updatedAt=" + updatedAt + ", ownerSeqType=" + ownerSeqType + ", createdBy=" + createdBy
				+ ", totalTime=" + totalTime + ", businessStatus=" + businessStatus + ", taskSla=" + taskSla
				+ ", ownerId=" + ownerId + ", processDefinitionId=" + processDefinitionId + "]";
	}
