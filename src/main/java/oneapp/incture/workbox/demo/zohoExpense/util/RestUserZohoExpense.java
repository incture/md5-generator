...
@Component
public class RestUserZohoExpense {
	...
	public RestResponse callGetService(String requestUrl, String accessToken, Map<String, String> parameters) {
		...
		try {
			...
			System.err.println("[WBP-Dev]RestUserZohoExpense.callGetService() : " + e.getMessage());
		}
		return restResponse;
	}

	public RestResponse callPostService(String requestUrl, String accessToken, Map<String, String> parameters) {
		RestResponse restResponse = null;
		HttpResponse response = null;
		HttpClient client = null;
		...
		try {
			...
			System.err.println("[WBP-Dev]RestUserZohoExpense.callPostService() : " + e.getMessage());
		}
		return restResponse;
	}
}
